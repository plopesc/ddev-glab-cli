...
By default, the add-on installs GitLab CLI version `1.90.0`. To use a different version, create a `.ddev/docker-compose.glab-cli.yaml` file with the desired version:
